...
$switcher['repeat'] = [Message::REPEAT_DISABLED => [], Message::REPEAT_ENABLED => ['repeat_interval', 'repeat_frequency', 'repeat_end_type', 'repeat_end_date', 'repeat_end_count']];
$switcher['repeat_end_type'] = [
    Message::REPEAT_END_NEVER => [], 
    Message::REPEAT_END_DATE => ['repeat_end_date'], 
    Message::REPEAT_END_COUNT => ['repeat_end_count']
];
$form->addItem([
...
$form->addItem([
    ...
    new CFormField([
        ...
        (new CSelect('repeat_interval'))
            ...
            ->addOption(new CSelectOption(Message::REPEAT_DAY, _('Day(s)')))
            ->addOption(new CSelectOption(Message::REPEAT_WEEK, _('Week(s)')))
            ->addOption(new CSelectOption(Message::REPEAT_MONTH, _('Month(s)')))
            ->addOption(new CSelectOption(Message::REPEAT_YEAR, _('Year(s)')))
    ])
]);
...
$form->addItem([
    ...
    new CFormField([
        (new CRadioButtonList('repeat_end_type', (int) $data['repeat_end_type']))
            ->addValue(_('Never'), Message::REPEAT_END_NEVER)
            ->addValue(_('On date'), Message::REPEAT_END_DATE)
            ->addValue(_('After occurrences'), Message::REPEAT_END_COUNT)
            ->setModern()
    ])
]);
...
$form->addItem([
    new CLabel(_('Message bar color'), 'message_color'),
    new CFormField(
